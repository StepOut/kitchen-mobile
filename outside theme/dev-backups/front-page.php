...
<header id="top" class="header">
  <div class="text-vertical-center"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/splash-01.png" class="img-responsive" style="margin:100px auto auto auto;" /> 
    <br clear="all">
    <div class="splash-section" style="margin-bottom:10px;"> <a href="m/home" class="btn btn-success btn-splash">Explore<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon-splash-proceed.png"></a> </div>
    <div class="splash-section"> <a href="order" class="btn btn-success btn-splash">Order<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon-splash-proceed.png"></a> </div>
  </div>
  </div>
</header>
