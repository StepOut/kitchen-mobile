...
<html lang="en">
    ...
    <body>
        ...
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/homepage-ui/common-files/js/jquery-1.10.2.min.js"></script>
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/homepage-ui/flat-ui/js/bootstrap.min.js"></script>
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/homepage-ui/common-files/js/modernizr.custom.js"></script>
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/homepage-ui/common-files/js/jquery.parallax.min.js"></script>
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/homepage-ui/common-files/js/startup-kit.js"></script>
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/homepage-ui/js/script.js"></script>
    </body>
</html>