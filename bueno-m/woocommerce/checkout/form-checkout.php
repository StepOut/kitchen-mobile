...
<a href="<?php echo $woocommerce->cart->get_cart_url(); ?>">
	<div class="btn-orange pull-right">Add more items</div>
</a>
...
<form name="checkout" method="post" class="checkout" action="<?php echo esc_url( $get_checkout_url ); ?>" enctype="multipart/form-data">
	...
	<?php if ( sizeof( $checkout->checkout_fields ) > 0 ) : ?>
		...
		<?php endif; ?>
            ...
            <?php $check_total = woocommerce_price( WC()->cart->total);
					$check_total = preg_replace("/[^0-9\.]/", '', $check_total);
		...
		<h2 id="order_review_heading"><?php _e( 'Checkout', 'woocommerce' ); ?></h2>
		<?php if($check_total > '15000'){ ?>
        	<style>
				.payment_method_cod{
					display:none;
				}
