	...
	<td>
		...
		<?php elseif ( ! WC()->customer->get_shipping_state() || ! WC()->customer->get_shipping_postcode() ) : ?>
			...
			<?php elseif ( is_cart() ) : ?>
				...
				<p><?php _e( 'Please continue to the checkout and enter your full address to see if service is available in your area.', 'woocommerce' ); ?></p>

			<?php else : ?>

				<p><?php _e( 'It seems the service is not available at the address above. Please fill in your complete address to calculate your delivery charges.', 'woocommerce' ); ?></p>
