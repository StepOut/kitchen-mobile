...
<div id="cart-page-calc">
  <div colspan="6" class="actions">
    ...
    <p>Date: <input type="text" id="datetimepicker3" placeholder="Please Select Date and Time" disabled/>
    <!--<input required type="text" placeholder="mm/dd/yyyy" id="datepicker" value="<?php //echo $_SESSION['order_date']; ?>">--> </p>
    <p>Time: 
