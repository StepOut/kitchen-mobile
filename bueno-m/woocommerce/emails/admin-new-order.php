...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
	...
	<tbody>
		...
		echo $_SESSION['service_rqst']['helper']." ";
		echo $_SESSION['service_rqst']['crockery']." ";
		echo $_SESSION['service_rqst']['waiter']." ";
		echo $_SESSION['service_rqst']['warming']." ";
		?>
        </td>
        ...
        <?php if (!isset($_SESSION)) { session_start();}
	   	echo "Delivery Time: ";
			echo $_SESSION['order_hours'].":".$_SESSION['order_minutes']." ".$_SESSION['order_day_time'];
		?>
        </td>
