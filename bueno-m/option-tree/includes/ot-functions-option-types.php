      ...
      echo '<div class="format-setting-inner">';
        ...
        foreach ( (array) $field_choices as $key => $choice ) {
          ...
          echo '<div class="option-tree-ui-radio-images">';
            ...
            echo '<img src="'.OT_URL.'' . esc_attr( $choice['src'] ) . '" alt="' . esc_attr( $choice['label'] ) .'" title="' . esc_attr( $choice['label'] ) .'" class="option-tree-ui-radio-image ' . esc_attr( $field_class ) . ( $field_value == $choice['value'] ? ' option-tree-ui-radio-image-selected' : '' ) . '" />';
          echo '</div>';
