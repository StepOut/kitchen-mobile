          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Mobili Options', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Mobili Options', 'option-tree' ) ),
...
if ( ! function_exists( 'ot_register_settings_page' ) ) {
  ...
  function ot_register_settings_page() {
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => __( 'Mobili Import/Export', 'option-tree' ),
        'menu_title'      => __( 'Mobili Import/Export', 'option-tree' ),
